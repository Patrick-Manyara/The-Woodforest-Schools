                ...
                <div class="col-xxl-10 col-lg-9">
                    <div class="tp-cta-wrapper d-flex align-items-center">
                        <div class="tp-cta-logo">
                            <a href="index.php"><img src="assets/img/logo/logo.png" style="width:100px;" alt=""></a>
                        </div>
                        <div class="tp-cta-content">
                            <span>EXPLORE OUR PROGRAMS - ENROLL TODAY!</span>
                            <h3 class="tp-cta-title">INNOVATIVE LEARNING FOR A BRIGHTER FUTURE.</h3>
                        </div>
                ...
                <div class="col-xxl-2 col-lg-3">
                    <div class="tp-cta-btn-wrap">
                        <div class="tp-cta-btn text-lg-end">
                            <a class="tp-btn" href="contact.php">Apply Now
